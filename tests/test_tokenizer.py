...
def get_tokenizer_from_vocab_merges_path(
  ...
  vocab = {
      gpt2_vocab_index:
          bytes([gpt2_byte_decoder[token] for token in gpt2_vocab_item])
...
def test_split_text_with_special_tokens_prefers_longest_overlap():
  special_tokens = {"<|endoftext|>", "<|endoftext|><|endoftext|>"}
  text = "A<|endoftext|><|endoftext|>B<|endoftext|>C"
  assert bpe_tokenizer.split_text_with_special_tokens(special_tokens,
                                                      text) == ["A", "B", "C"]


def test_split_text_with_special_tokens_inclusive_prefers_longest_overlap():
  special_tokens = {"<|endoftext|>", "<|endoftext|><|endoftext|>"}
  text = "A<|endoftext|><|endoftext|>B<|endoftext|>C"
  assert bpe_tokenizer.split_text_with_special_tokens_inclusive(
      special_tokens,
      text) == ("A", "<|endoftext|><|endoftext|>", "B", "<|endoftext|>", "C")
